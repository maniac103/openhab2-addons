...
public class XmlRpcResponse implements RpcResponse {
    ...
    private class XmlRpcHandler extends DefaultHandler {
        ...
        private @Nullable StringBuilder tagValue;
        ...
        public void startElement(@Nullable String uri, @Nullable String localName, @Nullable String qName,
            ...
            String tag = Objects.requireNonNull(qName).toLowerCase();
        ...
        public void endElement(@Nullable String uri, @Nullable String localName, @Nullable String qName)
                throws SAXException {
            String currentTag = Objects.requireNonNull(qName).toLowerCase();
            String currentValue = Objects.requireNonNull(tagValue).toString();
